...
class CalculatorVC: UIViewController {
    ...
    private lazy var vStakView: UIStackView = {
    ...
    private func bind(){
        ...
        output.updateViewPubliser.sink { [unowned self] result in
    ...
    private func layout() {
        ...
        view.addSubview(vStakView)
        
        vStakView.snp.makeConstraints { make in
