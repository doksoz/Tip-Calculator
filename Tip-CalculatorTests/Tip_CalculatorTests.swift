...
final class Tip_CalculatorTests: XCTestCase {
    ...
    func testResultWithoutTipFor1Person(){
        ...
        //then
        output.updateViewPubliser.sink { result in
    ...
    func testSoundPlayedAndCalculatorResetOnLogoViewTap(){
        ...
        let output = sut.transform(input: input)
        let expect1 = XCTestExpectation(description: "reset calculator to be called")
        let expect2 = audioPlayerService.expectation
        //then
